-- list_activity_feed: one-round-trip home/profile activity.
-- Safe to re-run in Supabase SQL Editor.
--
-- p_feed = true  → self + people you follow
-- p_feed = false → only p_user_id
-- p_before       → cursor for older pages (created_at of last item)
